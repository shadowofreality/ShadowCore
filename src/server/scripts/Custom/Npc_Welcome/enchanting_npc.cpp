...
public:
	...
	void ShowHeadMenu(Player* player, Creature* creature)
	{
		...
		AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Arcanum of Burning Mysteries -- 30 Spell Power + 20 Crit", GOSSIP_SENDER_MAIN,
			ENCHANT_HEAD_BURNING_MYSTERIES);
		AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Arcanum of Dominance -- 29 Spell Power + 20 Resil", GOSSIP_SENDER_MAIN,
		...
		AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Arcanum of The Stalwart Protector -- 37 Stamina + 20 Defense", GOSSIP_SENDER_MAIN,
			ENCHANT_HEAD_STALWART_PROTECTOR);
		AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Arcanum of Torment -- 50 Attack Power + 20 Crit", GOSSIP_SENDER_MAIN,
